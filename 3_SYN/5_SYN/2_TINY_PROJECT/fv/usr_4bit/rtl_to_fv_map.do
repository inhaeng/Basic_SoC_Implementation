...
# Generated on: Thu Jul 09 04:39:21 KST 2026 (Wed Jul 08 19:39:21 UTC 2026)
...
set logfile fv/usr_4bit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/usr_4bit -revised fv_map
...
add_search_path /home/hah011/Basic_SoC_Implementation/1_RTL/2_TINY_PROJECT -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah011/Basic_SoC_Implementation/1_RTL/2_TINY_PROJECT/usr_4bit.v
elaborate_design -golden -root {usr_4bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/usr_4bit/fv_map.v.gz
elaborate_design -revised -root {usr_4bit}
...
#add_name_alias fv/usr_4bit/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.usr_4bit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.usr_4bit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.usr_4bit.rtl.fv_map.rpt
