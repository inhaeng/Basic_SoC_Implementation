...
# Generated on: Wed Jul 08 04:51:30 KST 2026 (Tue Jul 07 19:51:30 UTC 2026)
...
set logfile fv/bidirectional_bus_driver/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/bidirectional_bus_driver -revised fv_map
...
add_search_path /home/hah011/Basic_SoC_Implementation/3_SYN/1_LIB -library -both
read_library -liberty -both \
    /home/hah011/Basic_SoC_Implementation/3_SYN/1_LIB/slow_vdd1v0_basicCells.lib
...
add_search_path /home/hah011/Basic_SoC_Implementation/1_RTL/4_COMB_LOGIC/5_THREE_STATE_BUS/3_BIDIRECTIONAL_BUS_DRIVER -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah011/Basic_SoC_Implementation/1_RTL/4_COMB_LOGIC/5_THREE_STATE_BUS/3_BIDIRECTIONAL_BUS_DRIVER/bidirectional_bus_driver.v
elaborate_design -golden -root {bidirectional_bus_driver} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/bidirectional_bus_driver/fv_map.v.gz
elaborate_design -revised -root {bidirectional_bus_driver}
...
set_system_mode lec
write_compared_points noneq.compared_points.bidirectional_bus_driver.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.bidirectional_bus_driver.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.bidirectional_bus_driver.rtl.fv_map.rpt
