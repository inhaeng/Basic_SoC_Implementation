...
# Generated on: Wed Jul 08 04:54:17 KST 2026 (Tue Jul 07 19:54:17 UTC 2026)
...
set logfile fv/fdivider/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fdivider -revised fv_map
...
add_search_path /home/hah011/Basic_SoC_Implementation/1_RTL/5_SEQ_LOGIC/3_FREQ_DIVIDER -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah011/Basic_SoC_Implementation/1_RTL/5_SEQ_LOGIC/3_FREQ_DIVIDER/fdivider.v
elaborate_design -golden -root {fdivider} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/fdivider/fv_map.v.gz
elaborate_design -revised -root {fdivider}
...
#add_name_alias fv/fdivider/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fdivider.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fdivider.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fdivider.rtl.fv_map.rpt
