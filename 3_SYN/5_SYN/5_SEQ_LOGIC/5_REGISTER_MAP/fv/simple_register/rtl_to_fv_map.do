...
# Generated on: Wed Jul 08 04:58:39 KST 2026 (Tue Jul 07 19:58:39 UTC 2026)
...
set logfile fv/simple_register/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/simple_register -revised fv_map
...
add_search_path /home/hah011/Basic_SoC_Implementation/1_RTL/5_SEQ_LOGIC/5_REGISTER_MAP -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah011/Basic_SoC_Implementation/1_RTL/5_SEQ_LOGIC/5_REGISTER_MAP/simple_register.v
elaborate_design -golden -root {simple_register} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/simple_register/fv_map.v.gz
elaborate_design -revised -root {simple_register}
...
#add_name_alias fv/simple_register/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.simple_register.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.simple_register.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.simple_register.rtl.fv_map.rpt
